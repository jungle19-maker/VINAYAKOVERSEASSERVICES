      ...
      <div className="container mx-auto px-6 max-w-[90rem]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((svc, i) => (
            <div
              key={i}
              className="group relative h-[420px] md:h-[480px] rounded-2xl overflow-hidden shadow-lg border border-[#E5E7EB] bg-[#0B1F3A] cursor-pointer flex flex-col justify-end transform transition-transform duration-500 hover:shadow-2xl hover:-translate-y-2 lg:last:col-span-1"
            >
              {/* Background Image */}
              <Image
                src={svc.img}
              ...
              <div className="relative z-20 p-8 flex flex-col h-full justify-end">
                <span className="inline-block py-1 px-3 mb-4 rounded-full bg-[#F5B301]/20 text-[#F5B301] border border-[#F5B301]/30 text-xs font-bold uppercase tracking-wider w-fit transform transition-transform duration-500 group-hover:-translate-y-2">
                  {svc.category}
                </span>
