      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="lg:sticky lg:top-28">
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#F5B301] hover:bg-[#d9a000] text-[#23352b] font-bold text-sm rounded-full transition-all shadow hover:shadow-[#F5B301]/30 hover:-translate-y-0.5"
            >
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span className={`flex-shrink-0 ml-3 w-6 h-6 rounded-full flex items-center justify-center transition-colors ${isOpen ? "bg-[#F5B301] text-[#23352b]" : "bg-[#F1F5F9] text-[#4B5563]"
                      }`}>
                      {isOpen
