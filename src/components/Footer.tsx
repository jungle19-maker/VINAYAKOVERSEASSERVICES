      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6 lg:col-span-1">
            <Image
              ...
              width={200}
              height={60}
              className="bg-white/95 p-2 rounded-lg"
            />
            ...
            <div className="flex gap-3">
              {[Globe, MessageCircle, Users, Share2].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-9 h-9 rounded-full bg-white/8 border border-white/10 flex items-center justify-center hover:bg-[#F5B301] hover:text-[#23352b] hover:border-[#F5B301] transition-all"
                >
          ...
          <div>
            <h4 className="text-white font-bold text-base mb-6 relative inline-block">
              Quick Links
              <span className="absolute -bottom-2 left-0 w-8 h-[2px] bg-[#F5B301] rounded-full" />
            </h4>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2 text-xs text-white/35 bg-white/5 px-4 py-2 rounded-full border border-white/10">
