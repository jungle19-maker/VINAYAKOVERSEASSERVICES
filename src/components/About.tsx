          ...
          <div className="lg:w-1/2 relative">
            ...
            <div className="absolute -bottom-6 left-4 right-4 z-20 flex gap-3">
              {statBadges.map((badge, i) => (
                <div
                  key={i}
                  className="flex-1 bg-white text-[#0B1F3A] p-4 rounded-xl shadow-[0_10px_30px_rgba(11,31,58,0.1)] text-center border border-[#E5E7EB]"
                >
                  ...
                  <div className="text-[10px] font-semibold text-[#4B5563] uppercase tracking-wide leading-tight">
                    {badge.label}
                  </div>
                </div>
              ))}
        ...
        <div className="mt-24 border-t border-[#E5E7EB] pt-16">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/3">
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#F1F5F9] rounded-lg border border-[#E5E7EB]">
                <Award className="w-5 h-5 text-[#F5B301]" />
                <span className="text-sm font-bold text-[#0B1F3A]">B-3393/HP/PER/100/5/11399/2026</span>
              </div>
            </div>
            <div className="md:w-2/3">
              <div className="rounded-2xl overflow-hidden border border-[#E5E7EB] shadow-xl relative w-full h-[400px] md:h-[500px]">
                <Image
