        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2 space-y-8 pt-6 lg:pt-0">
            ...
            <p className="text-[#4B5563] leading-relaxed text-lg">
              VOS (Vinayak Overseas Services) is a trusted overseas recruitment company in India, specializing in skilled manpower solutions across key industries such as construction, oil & gas, healthcare, hospitality, and manufacturing. Backed by a robust compliance framework aligned with Government of India regulations,
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="md:w-1/3">
                ...
                <p className="text-[#4B5563] text-sm leading-relaxed mb-6">
                  VOS Website is an officially certified recruiting agent by the Ministry of External Affairs, Government of India.
                </p>
